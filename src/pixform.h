...
#define BUILD_PIXEL_RGB565(R, G, B)                                            \
	(((int)(R) << 11) | ((int)(G) << 6) | (int)(B))
#define BUILD_PIXEL2_RGB565(R, G, B)                                           \
	(((int)(R) << 11) | ((int)(G) << 5) | (int)(B))
...
/* BGR565 format */
#define BUILD_PIXEL_BGR565(R, G, B)                                            \
	(((int)(B) << 11) | ((int)(G) << 6) | (int)(R))
#define BUILD_PIXEL2_BGR565(R, G, B)                                           \
	(((int)(B) << 11) | ((int)(G) << 5) | (int)(R))
...
#define BUILD_PIXEL_BGR555(R, G, B)                                            \
	(((int)(B) << 10) | ((int)(G) << 5) | (int)(R))
#define BUILD_PIXEL2_BGR555(R, G, B)                                           \
	(((int)(B) << 10) | ((int)(G) << 5) | (int)(R))
...
/* GBR565 format */
#define BUILD_PIXEL_GBR565(R, G, B)                                            \
	(((int)(G) << 11) | ((int)(B) << 6) | (int)(R))
#define BUILD_PIXEL2_GBR565(R, G, B)                                           \
	(((int)(G) << 11) | ((int)(B) << 5) | (int)(R))
...
/* GBR555 format */
#define BUILD_PIXEL_GBR555(R, G, B)                                            \
	(((int)(G) << 10) | ((int)(B) << 5) | (int)(R))
#define BUILD_PIXEL2_GBR555(R, G, B)                                           \
	(((int)(G) << 10) | ((int)(B) << 5) | (int)(R))
...
/* RGB5551 format */
#define BUILD_PIXEL_RGB5551(R, G, B)                                           \
	(((int)(R) << 11) | ((int)(G) << 6) | (int)((B) << 1) | 1)
#define BUILD_PIXEL2_RGB5551(R, G, B)                                          \
	(((int)(R) << 11) | ((int)(G) << 6) | (int)((B) << 1) | 1)
...
#define DECOMPOSE_PIXEL_D(F, PIX, R, G, B)                                     \
	CONCAT(DECOMPOSE_PIXEL_, F)(PIX, R, G, B)
...
#define DECOMPOSE_PIXEL(PIX, R, G, B)                                          \
	DECOMPOSE_PIXEL_D(PIXEL_FORMAT, PIX, R, G, B)
...
#define RGB_LOW_BITS_MASK                                                      \
	(RED_LOW_BIT_MASK | GREEN_LOW_BIT_MASK | BLUE_LOW_BIT_MASK)
#define RGB_HI_BITS_MASK                                                       \
	(RED_HI_BIT_MASK | GREEN_HI_BIT_MASK | BLUE_HI_BIT_MASK)
#define RGB_HI_BITS_MASKx2                                                     \
	((RED_HI_BIT_MASK | GREEN_HI_BIT_MASK | BLUE_HI_BIT_MASK) << 1)
